    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
      <GlassCard variant="strong" className="p-8">
        ...
        <p className="text-sm text-white/50 mb-6">
          {sent ? 'Check your email for reset instructions.' : 'Enter your email and we will send reset instructions.'}
        </p>

        {sent ? (
          <div className="glass-brand rounded-2xl p-6 text-center">
            <CheckCircle className="w-10 h-10 text-brand-400 mx-auto mb-3" />
            <p className="text-sm text-white/70">Instructions sent to <span className="text-brand-400 font-medium">{email}</span></p>
